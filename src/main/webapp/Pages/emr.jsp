...
<%
    ...
    // Each EMR section is only interactive for its matching role.
    // Every other role sees it locked (visible, but disabled + dimmed).
    ...
    String unlockedRing = "ring-2 ring-emerald-500 ring-offset-2";
    ...
    String fieldsetDim = "group-disabled:opacity-45 group-disabled:grayscale-[.6] transition-opacity";
%>
...
<div class="max-w-5xl mx-auto bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden">
    ...
    <header class="bg-linear-to-r from-emerald-700 to-teal-600 text-white px-6 md:px-8 py-5">
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
            ...
            <div class="text-sm md:text-base space-y-1 md:text-right">
                ...
                <p>
                    <span class="text-emerald-100">Logged in as :</span>
                    <span class="font-semibold text-white"><%= userRole %></span>
                </p>
            </div>
        </div>
    </header>
    ...
    <form id="emrForm" action="#" method="post">
        ...
        <section id="section-registration" data-access-role="receptionist"
                 class="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden <%= isReceptionist ? unlockedRing : "" %>">
            <div class="bg-emerald-500 px-5 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <% if (!isReceptionist) { %>
                    <span class="<%= lockBadge %>">🔒 Receptionist Only</span>
                    <% } %>
            ...
            <fieldset class="group">
                ...
                <fieldset disabled class="group">
                    <% } %>
                    <div class="grid grid-cols-2 gap-4 p-5 <%= fieldsetDim %>">
                        <div>
        ...
        <!-- 2. Reception -->
        <section id="section-reception" data-access-role="receptionist"
                 class="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden mt-5 <%= isReceptionist ? unlockedRing : "" %>">
        ...
        <section id="section-doctor" data-access-role="doctor"
                 class="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden mt-5 <%= isDoctor ? unlockedRing : "" %>">
            <div class="bg-gradient-to-r from-emerald-50 to-cyan-50 border-b border-emerald-200 px-5 py-3 flex justify-between items-center">
                <div>
                ...
                <% if (!isDoctor) { %>
                <span class="<%= lockBadge %>">🔒 Doctor Only</span>
                <% } %>
            </div>
        ...
        <section id="section-lab" data-access-role="lab"
                 class="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden mt-5 <%= isLab ? unlockedRing : "" %>">
            <div class="bg-gradient-to-r from-emerald-50 to-cyan-50 border-b border-emerald-200 px-5 py-3 flex justify-between items-center">
                <div>
                ...
                <% } else { %>
                <span class="<%= lockBadge %>">🔒 Lab Only</span>
                <% } %>
            </div>
        ...
        <section id="section-pharmacy" data-access-role="pharmacy"
                 class="bg-white border border-emerald-200 rounded-2xl shadow-xl overflow-hidden mt-5 <%= isPharmacy ? unlockedRing : "" %>">
            <div class="bg-gradient-to-r from-emerald-50 to-cyan-50 border-b border-emerald-200 px-5 py-3 flex justify-between items-center">
                <div>
                ...
                <% } else { %>
                <span class="<%= lockBadge %>">🔒 Pharmacy Only</span>
                <% } %>
            </div>
