    ...
    <div class="bg-white rounded-2xl shadow-xl border border-emerald-200 overflow-hidden">
        ...
        <div class="bg-emerald-500 text-white px-6 py-4 flex justify-between items-center">
            ...
            <div>
                ...
                <p class="text-emerald-100 text-sm">
                    Patients waiting to receive prescribed medicines
                </p>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="w-full">
                ...
                <tbody id="pharmacyQueue">

                <!--
                    Empty.
                    Patients will appear here automatically
                    after doctor consultation or laboratory completion.
                -->
