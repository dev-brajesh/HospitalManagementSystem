...
<%
    ...
    if (userRole == null || !"LAB".equalsIgnoreCase(userRole)) {
        response.sendRedirect("login.jsp");
        return;
    }
    String labStaffName = (String) session.getAttribute("fullName");
    if (labStaffName == null) labStaffName = "Laboratory Staff";

    List<Visit> queue = null;
    try {
        queue = new VisitDAO().findVisitsByStatus("LAB");
    } catch (Exception e) {
        e.printStackTrace();
    }
%>
...
<div class="max-w-5xl mx-auto">
    ...
    <header class="bg-linear-to-r from-emerald-700 to-teal-600 text-white px-6 md:px-8 py-5 rounded-2xl shadow-xl">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <div class="text-left md:text-right">
                <h2 class="text-2xl font-bold">Laboratory Dashboard</h2>
                <p class="text-emerald-100">Welcome, <%= labStaffName %></p>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-emerald-200 overflow-hidden">
        <div class="bg-emerald-500 text-white px-6 py-4">
            <h2 class="text-xl font-bold">Laboratory Test Queue</h2>
            <p class="text-emerald-100 text-sm">Patients referred by doctors for laboratory investigation</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">Test Name</th>
                    <th class="px-6 py-4 text-center">Action</th>
                </tr>
                </thead>
                <tbody>
                <% if (queue == null || queue.isEmpty()) { %>
                <tr><td colspan="5" class="p-6 text-center text-slate-400">No pending lab tests</td></tr>
                <% } else {
                    int sno = 1;
                    for (Visit v : queue) { %>
                <tr class="border-t border-emerald-100">
                    ...
                    <td class="px-6 py-4"><%= v.getLabTestName() != null ? v.getLabTestName() : "-" %></td>
